...
# Verify files exist
test -f src/schema/petstoreSchema.ts && echo "✓ Schema created"
test -f src/apiRegistry.ts && echo "✓ Registry created"

# Check imports
grep -q "import.*petstoreSchema" src/apiRegistry.ts && echo "✓ Import correct"
```
